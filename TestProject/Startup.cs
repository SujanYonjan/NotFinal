...
namespace TestProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("TestProjectDbEntities")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<ApplicationUser> _userManager, RoleManager<IdentityRole> _roleManager)
        {
            ...
            app.UseRouting();
            //using Authorization to Authenticate the User
